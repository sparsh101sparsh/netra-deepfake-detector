...
#align(center)[
  ...
  #v(0.1cm)
  #text(11pt, style: "italic", fill: rgb("#4A5568"))[Comparative Performance on 100 Neural Face-Swapped Talker Videos]
  #v(0.4cm)
]
...
#rect(
  ...
  - *CLIP ViT Probe* achieved a *100% Detection Rate* (100/100) with *58.4%* mean confidence, demonstrating high zero-shot transfer on unseen face textures.
