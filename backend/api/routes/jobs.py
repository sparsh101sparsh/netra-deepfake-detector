...
STAGE_LABELS = {
    ...
    "image_download": "Downloading media & verifying headers",
    "image_visual_ocr": "Scanning dual-branch visual & OCR streams",
    "image_facial_threat": "Synthesizing facial anomaly maps & IOC threat cross-match",
    "image_dossier": "Finalizing hybrid forensic dossier",
    "Downloading media & verifying headers": "Downloading media & verifying headers",
    "Scanning dual-branch visual & OCR streams": "Scanning dual-branch visual & OCR streams",
    "Synthesizing facial anomaly maps & IOC threat cross-match": "Synthesizing facial anomaly maps & IOC threat cross-match",
    "Finalizing hybrid forensic dossier": "Finalizing hybrid forensic dossier",
