...
class ReportThreatRequest(BaseModel):
    ...
    device_model: Optional[str] = "Direct Mobile Upload"
    software_used: Optional[str] = "Synthetic Video Generator"
...
'''
    ...
    try:
        subprocess.run(["/opt/homebrew/bin/typst", "compile", typ_path, pdf_path], check=True)
