...
function pass(suite: string, name: string, details: string, metrics?: Record<string, any>) {
  results.push({ suite, name, status: "PASS", details, metrics });
}

function fail(suite: string, name: string, details: string, metrics?: Record<string, any>) {
  results.push({ suite, name, status: "FAIL", details, metrics });
}

function warn(suite: string, name: string, details: string, metrics?: Record<string, any>) {
...
function test1Point5PixelBorders() {
  ...
  const file1Point5Counts: Record<string, number> = {};
