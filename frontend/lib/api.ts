...
export const PIPELINE_STAGES: PipelineStageConfig[] = [
  ...
  },
  {
    ...
    category: "Visual Seam Forensics",
    description: "Scanning face crops for boundary seams and blending artifacts",
    targetProgress: 30,
  ...
  },
  {
    ...
    category: "Generative AI Probe",
    description: "Evaluating embeddings for synthetic generative AI fingerprints",
    targetProgress: 50,
  ...
  },
  {
    ...
    description: "Vocal spectral profiling & synthetic voice clone detection",
    targetProgress: 65,
...
export const STAGE_LABELS: Record<string, string> = {
  ...
  spatial_vit: "Running NETRA Spatial Seam & visual manipulation scan…",
  clip_probe: "Scanning NETRA Generative AI synthetic signatures…",
  audio_analysis: "Analyzing NETRA Voice Clone acoustic frequencies…",
  ...
  "Running spatial deepfake detector": "Running NETRA Spatial Seam & visual manipulation scan…",
  "Running CLIP generalisation detector": "Scanning NETRA Generative AI synthetic signatures…",
  "Running audio deepfake detector": "Analyzing NETRA Voice Clone acoustic frequencies…",
