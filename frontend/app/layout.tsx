...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/netra_favicon.svg?v=6', type: 'image/svg+xml' },
      { url: '/favicon.svg?v=6', type: 'image/svg+xml' },
      { url: '/favicon.ico?v=6', sizes: 'any' },
    ],
    shortcut: '/netra_favicon.svg?v=6',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark font-sans" suppressHydrationWarning>
      <head>
        <link rel="icon" type="image/svg+xml" href="/netra_favicon.svg?v=6" />
        <link rel="icon" sizes="any" href="/favicon.ico?v=6" />
