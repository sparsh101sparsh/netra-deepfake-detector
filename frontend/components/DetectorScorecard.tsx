  ...
  const items: ScorecardItem[] = [
    {
      ...
      badge: "Gen-AI Scanner",
      score: effectiveGenD,
      icon: Brain,
      description: "Zero-shot generative synthetic face and AI creation detector",
    ...
    },
    {
      ...
      score: visualScore,
      icon: Eye,
      description: "Facial boundary blending & pixel-level alteration forensics",
    ...
    },
    {
      ...
      score: null,
      icon: Microscope,
      description: "Frequency artifacts, blink cadence & container metadata",
