          ...
          <div className="flex items-center gap-2">
            ...
            >
              <div className="size-4 flex items-center justify-center shrink-0">
                <svg className="size-3.5 fill-[#25D366] group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              <span className="hidden sm:inline-block leading-none text-xs font-semibold text-ink">WhatsApp</span>
          ...
          <div className="md:hidden border-t border-line bg-surface/98 backdrop-blur-xl px-4 py-4 space-y-2 animate-in slide-in-from-top duration-200">
            <div className="flex items-center justify-between pb-2 border-b border-line">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold font-sans bg-inset hover:bg-hover text-ink border border-line"
              >
                <div className="size-4 flex items-center justify-center shrink-0">
