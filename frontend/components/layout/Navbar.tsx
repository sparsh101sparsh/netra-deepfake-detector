  ...
  useLayoutEffect(() => {
    const updatePosition = () => {
      ...
      if (targetElement && container) {
        ...
        setNavHighlight({ left, top, width, height });
      }
    };
    ...
    <>
      ...
      >
        <div className="w-full max-w-[1720px] mx-auto px-4 sm:px-8 lg:px-12 h-16 sm:h-18 flex items-center justify-between gap-4">
          ...
          {/* Right Action Cluster: WhatsApp Bot + Auth */}
          <div className="flex items-center gap-2">
            {/* WhatsApp Forensic Bot Direct Trigger */}
            <a
              href="https://wa.me/14155238886?text=menu"
              target="_blank"
              rel="noopener noreferrer"
              title="Open Official NETRA × CORSAIR WhatsApp Forensic Bot"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold font-sans bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/40 hover:border-[#25D366] text-[#25D366] transition-all shadow-sm shadow-[#25D366]/10 group cursor-pointer select-none"
            >
              <svg className="size-3.5 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              <span className="hidden sm:inline-block leading-none">WhatsApp</span>
          ...
          <div className="md:hidden border-t border-line bg-surface/98 backdrop-blur-xl px-4 py-4 space-y-2 animate-in slide-in-from-top duration-200">
            <div className="flex items-center justify-between pb-2 border-b border-line">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-xs text-[#25D366] font-semibold"
              >
