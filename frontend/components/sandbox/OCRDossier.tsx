        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          <Button
            ...
            onClick={() => generateForensicPDF({
              ...
              city: (data as any)?.city || "Bengaluru",
              state: (data as any)?.state || "Karnataka",
              lat: (data as any)?.lat ?? 12.9716,
              lng: (data as any)?.lng ?? 77.5946,
              locationSource: (data as any)?.location_source || "DOCUMENT_OCR_ENTITY",
              ocrAnalysis: {
