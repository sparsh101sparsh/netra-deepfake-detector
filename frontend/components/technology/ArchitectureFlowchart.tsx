...
export const ARCHITECTURE_NODES: FlowNode[] = [
  // Row 0: Ingestion Trigger
  {
    ...
    x: 0.5,
    w: 360,
    kind: { label: "Ingress", hue: PURPLE },
    hue: PURPLE,
    title: "Multi-Modal Ingestion Gateway",
    caption: "Web Dropzone (MP4/MOV/PNG) & Meta WhatsApp Cloud API Ingress",
    tag: "FastAPI Gateway",
    latency: "< 120 ms",
    icon: Upload,
  },
  ...
  // Row 1: Async Task Distribution & Decoding
  {
    ...
    x: 0.5,
    w: 380,
    kind: { label: "Queue & Demux", hue: CYAN },
    hue: CYAN,
    title: "Stream Processing & Task Queue",
    caption: "Decoupled cloud queue extracting synchronized video frames, audio tracks & metadata",
    tag: "FFmpeg Demux",
    latency: "~450 ms",
    icon: Layers,
  },

  // Row 2: Alignment & Stream Splitting Preprocessors
  {
    id: "insightface",
    modelId: "insightface",
    row: 2,
    ...
    hue: SKY,
    title: "RetinaFace 3D Landmark Aligner",
    caption: "Tracks 3D facial landmarks, head pose orientation & canonical 224×224 crops",
    tag: "Face Tracking",
    latency: "18 ms/f",
    icon: Eye,
  },
  {
    ...
    hue: EMERALD,
    title: "FFmpeg Speech & Acoustic Demuxer",
    caption: "Isolates clean speech channels, eliminates noise & prepares spectrograms",
    tag: "Voice Demux",
    latency: "42 ms",
    icon: Radio,
  },
  {
    ...
    x: 0.78,
    w: 310,
    kind: { label: "OCR Ingress", hue: AMBER },
    hue: AMBER,
    title: "RapidOCR Text & Document Extractor",
    caption: "Extracts visible screen text, financial receipts, UPI IDs & document typography",
    tag: "Document OCR",
    latency: "120 ms",
    icon: Terminal,
  },
  ...
  // Row 3: Parallel Specialist Detectors
  {
    ...
    hue: ROSE,
    title: "Spatial Seam Detector (NPR ResNet-50)",
    caption: "High-pass spatial probe scanning face-swap blending seams and lattice artifacts",
    tag: "Face Swap (W: 0.40)",
    latency: "14 ms/batch",
    icon: Cpu,
  },
  {
    ...
    hue: VIOLET,
    title: "Generative AI Detector (GenD ViT-L)",
    caption: "Semantic foundation manifold detecting diffusion and generative synthetic textures",
    tag: "AI Gen (W: 0.20)",
    latency: "22 ms/batch",
    icon: Sparkles,
  },
  ...
  },
  {
    ...
    hue: AMBER,
    title: "Cyber Scam & Threat Classifier",
    caption: "NLP pattern matcher analyzing extortion keywords, phishing URLs & BNS violations",
    tag: "Threat Intel (W: 0.15)",
    latency: "180 ms",
    icon: Terminal,
  },
  {
    ...
    hue: CYAN,
    title: "Container & EXIF Inspector",
    caption: "Verifies MP4 container atoms, ISO 6709 geolocation & A/V lip-sync coherence",
    tag: "Aux Forensics",
    latency: "8 ms",
    icon: Shield,
  },

  // Row 4: Central Gated Fusion Engine
  {
    id: "gated_fusion",
    ...
    hue: AMBER,
    title: "Adaptive Multi-Modal Fusion Engine",
    caption: "Dynamic weighting algorithm conditioned on modality presence & evidence confidence",
    icon: Sliders,
    condition: true,
  },
  ...
  // Row 5: Structured Evidence & Forensic Dossier Synthesis
  {
    ...
    hue: BLUE,
    title: "Cryptographic Evidence Packager",
    caption: "Structured telemetry: frame timestamps, anomaly bounding boxes & SHA-256 digests",
  ...
  },
  {
    ...
    caption: "Compiles formal Section 65B/BSA evidentiary report from verified detector telemetry",
    tag: "Forensic Report",
    latency: "< 10 ms",
    icon: Sparkles,
  },
  ...
  // Row 6: Final Verdict & Multichannel Outpost
  {
    ...
    hue: EMERALD,
    title: "National Threat Radar & Incident Dispatch",
    caption: "Delivers WhatsApp citizen verdict, updates National Threat Radar & issues signed PDF",
    tag: "Live Delivery",
    latency: "< 250 ms",
    icon: ShieldCheck,
  },
...
export const ARCHITECTURE_EDGES = [
  ...
  // Queue to Preprocessors & Container
  { from: "queue_ffmpeg", to: "insightface" },
  { from: "queue_ffmpeg", to: "audio_demux" },
  { from: "queue_ffmpeg", to: "ocr_demux" },
  { from: "queue_ffmpeg", to: "aux_engine" },

  // Preprocessors to Specialist Detectors
  { from: "insightface", to: "efficientnet_sbi" },
  { from: "insightface", to: "clip_probe" },
  { from: "audio_demux", to: "wav2vec" },
  { from: "ocr_demux", to: "scam_nlp" },

  // All 5 Specialist Detectors into Central Fusion Engine
